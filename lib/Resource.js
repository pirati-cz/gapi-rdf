(function() {
  ...
  Resource = (function() {
    ...
    Resource.prototype._resolveClassCall = function(prefix, method) {
      ...
      for (_i = 0, _len = types.length; _i < _len; _i++) {
        ...
        if (prefix === type_prefix) {
          if (this.environment.getClass != null) {
  ...
  ResourceNamespaceProxyHandler = {
    get: function(target, name, reciever) {
      ...
      return resource.get(prefix + ':' + name);
    },
